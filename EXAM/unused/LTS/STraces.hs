module EXAM_UTILS.LTS.STraces where
import           Data.List
import           Data.Map                       ( Map )
import qualified Data.Map                      as Map
import           Data.Tuple
import qualified Debug.Trace                   as Debug
import           EXAM_UTILS.LTS_Model_Based.LTSUtils
import           System.Random
import           Test.QuickCheck

-- Some convenient functions related to straces used from:
-- https://github.com/AndreasElgaard/SSVT-Exercises/blob/main/Examen/stracesFile.hs
